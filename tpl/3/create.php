...
if (! isset($_POST["nama"]) || ! isset($_POST["harga"])) {
    echo $twig->render("3/create.html");
} if (isset($_POST["nama"]) && isset($_POST["harga"])) {
    $nama  = $_POST["nama"];
    $harga = $_POST["harga"];
    ...
    if ($image) {
        ...
        // error 4 tidak ada file yang di upload
            ...
            echo $twig->render("3/error.html", array("pesan"=>"Error upload gambar produk"));
            return;
        }
    }
    ...
    if (! $result) {
        echo $twig->render("3/error.html", array("pesan"=>"Error query"));
    }
